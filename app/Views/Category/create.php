...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        ?>
                ...
                <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Cetagory</h5>

                            <?php //echo validation_list_errors();?>

                            <!-- No Labels Form -->
                            <form class="row g-3" action="/category/store" method="post" enctype="multipart/form-data">
                                <div class="col-md-12 mb-3">
                                    <input type="text" class="form-control" name="category" value="<?php set_value('category')?>" placeholder=" Add Category">
                                </div>
